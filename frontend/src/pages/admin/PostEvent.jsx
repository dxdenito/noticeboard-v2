...
export default function PostEvent() {
  ...
  useEffect(() => {
    api.get("/org-units/tree")
      .then((tree) => setOrgUnits(flattenTree(tree)))
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      showSuccess(
        event.status === "approved" ? "Event published" : "Event submitted for approval"
      );
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            {imagePreview ? (
              ...
              <label className="inline-flex items-center gap-1.5 text-xs font-semibold text-jkuat-blue cursor-pointer">
                <ImagePlus size={13} />
                Add a cover image
